...
public final class SvDiscoverFromLocalAssemblyContigAlignmentsSpark extends GATKSparkTool {
    ...
    public static void dispatchJobs(final EnumMap<RawTypes, JavaRDD<AssemblyContigWithFineTunedAlignments>> contigsByPossibleRawTypes,
        ...
        // for demo only: to centralize and replace the code above
        ...
        final JavaRDD<AssemblyContigWithFineTunedAlignments> nonComplexSignatures = contigsByPossibleRawTypes.get(RawTypes.InsDel)
        ...
        final SimpleNovelAdjacencyInterpreter simpleNovelAdjacencyInterpreter = new SimpleNovelAdjacencyInterpreter();
        final List<VariantContext> annotatedVariants = simpleNovelAdjacencyInterpreter
        ...
        SVVCFWriter.writeVCF(annotatedVariants, svDiscoveryInputData.outputPath,
